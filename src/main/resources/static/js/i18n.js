(function () {
    ...
    const translations = {
        pt: {
            ...
            'layout.nav.ariaLabel': 'Navegação principal',
            'layout.nav.catalog': 'Catálogo',
            'layout.nav.new': 'Cadastrar',
            'layout.nav.suggestion': 'Sugestões',
            ...
            'list.toolbar.label': 'Ações rápidas',
            ...
            'list.table.scrollHint': 'Arraste horizontalmente para ver mais colunas',
        ...
        en: {
            ...
            'layout.nav.ariaLabel': 'Main navigation',
            'layout.nav.catalog': 'Catalog',
            'layout.nav.new': 'New anime',
            'layout.nav.suggestion': 'Suggestions',
            ...
            'list.toolbar.label': 'Quick actions',
            ...
            'list.table.scrollHint': 'Drag horizontally to see all columns',
        ...
        es: {
            ...
            'layout.nav.ariaLabel': 'Navegación principal',
            'layout.nav.catalog': 'Catálogo',
            'layout.nav.new': 'Registrar',
            'layout.nav.suggestion': 'Sugerencias',
            ...
            'list.toolbar.label': 'Acciones rápidas',
            'list.table.title': 'Título',
            ...
            'list.table.scrollHint': 'Desliza horizontalmente para ver más columnas',
        ...
        jp: {
            ...
            'layout.nav.ariaLabel': 'メインナビゲーション',
            'layout.nav.catalog': 'カタログ',
            'layout.nav.new': '新規登録',
            'layout.nav.suggestion': 'おすすめ',
            ...
            'list.table.scrollHint': '横にスクロールして他の列を表示',
